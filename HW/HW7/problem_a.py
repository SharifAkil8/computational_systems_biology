...
# Load Excel file
df = pd.read_excel('/Users/sharif/Desktop/UNDERGRAD_COLLEGE/Spring_2024/ECEN453/HW/HW7/ALL_AML_FS_Annot.xlsx', sheet_name='ALL_AML_FS_Annot')

initial_gene_count = df.iloc[:, 0].nunique()
print(f"Gene Count: {initial_gene_count}")

# Isolate numerical data, first 3 columns are strings
...
significant_genes.to_excel('/Users/sharif/Desktop/UNDERGRAD_COLLEGE/Spring_2024/ECEN453/HW/HW7/significantly_diff_expressed_genes.xlsx', index=False)
